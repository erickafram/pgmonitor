...
<head>
    ...
    <script>
        ...
        function pegarSinal(signalId) {
            alert("Somente usuários GOLD podem pegar sinais, por favor faça a sua assinatura agora.");
        }
...
<td>
    ...
    <td><button class="btn btn-primary" onclick="pegarSinal(${signal.id})">Pegar Sinal</button></td>`;
...
<div class="container">
    ...
    <?php endif; ?>
    <button class="btn btn-danger btn-sm" onclick="deleteCookies()">Apagar Cookies</button><br><br>
    <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] === 'user'): ?>
        ...
        <div class="alert alert-warning">
            Descubra os segredos do sucesso com nosso exclusivo Gráfico de Horas Pagantes por jogo, disponível somente para assinantes!
            <a href="vendas.php">Assine agora</a> e amplie suas oportunidades de sucesso!
        </div>
    <?php endif; ?>
    <?php include 'popup_plataforma.php'; ?>
    <?php include 'grafico_horario_usuario.php'; ?> <br>
