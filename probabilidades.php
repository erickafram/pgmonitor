            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="alert alert-primary" role="alert" style="margin-top:10px;">
                        ...
                        <p>Aproveite o Fortune Calculadora para tomar decisões mais informadas em suas apostas no jogo Fortune Tiger. Lembre-se de que o jogo é baseado em estratégias, e essas estimativas não garantem resultados específicos. Divirta-se jogando de forma responsável e boa sorte!</p>
                    </div>
                </div>
            </div>
        </div>
...
if (isset($_POST["calcular"])) {
    ...
    if ($quantidade_rodadas * $valor_aposta > $banca) {
        ...
        $ganho_esperado = $probabilidade_total * $valor_aposta * 250 - ($quantidade_rodadas * $valor_aposta);
